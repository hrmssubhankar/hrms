...
const TIERS = [
  { value: 'starter',      label: 'Starter',       desc: '11 modules' },
  { value: 'professional', label: 'Professional',   desc: '20 modules' },
  { value: 'enterprise',   label: 'Enterprise',     desc: '28 modules' },
]
    ...
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Update tenant configuration</p>
        </div>
        <div className="flex gap-2">
          ...
          <Link
            href={`/super-admin/clients/${id}/theme`}
      ...
      {success && <div className="bg-green-900/50 border border-green-700 rounded-lg p-3 text-sm text-green-300">Changes saved successfully.</div>}
      ...
      <form onSubmit={handleSubmit} className="space-y-5 bg-gray-900 border border-gray-800 rounded-xl p-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <div className="flex-1 h-10 rounded-lg" style={{ background: `linear-gradient(135deg, ${form.primaryColor}, ${form.primaryColor}88)` }} />
          </div>
        </div>
