    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Self-reported diversity data to support equity and inclusion initiatives</p>
        </div>
      ...
      {showForm && (
        <form onSubmit={save} className="bg-gray-900 border border-purple-800 rounded-xl p-5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-400 mb-1 block">Gender Identity</label>
            ...
            <div>
              <label className="text-xs text-gray-400 mb-1 block">Cultural Background</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-sm text-gray-300">Aboriginal or Torres Strait Islander</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-sm text-gray-300">Living with a disability</span>
            </label>
          </div>
          <div>
            <label className="text-xs text-gray-400 mb-1 block">Workplace Adjustments Required</label>
